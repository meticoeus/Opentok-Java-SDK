...
public class OpenTokAsyncTest {
    ...
    public void setUp() throws OpenTokException {
        ...
        sdk = new OpenTokAsync.Builder(apiKey, apiSecret).apiUrl(apiUrl).build();
    }
    ...
    public void testCreateRoutedSession() throws OpenTokException {
        ...
        Session session = null;
        try {
            session = sdk.createSession(properties).get();
        } catch (InterruptedException | ExecutionException e) {
            throw new OpenTokException(e.getMessage());
        }
...
//    }
    ...
    public void testTokenDefault() throws
        ...
        OpenTokAsync opentok = new OpenTokAsync(apiKey, apiSecret);
    ...
    public void testGetArchive() throws OpenTokException {
        ...
        try {
            archive = sdk.getArchive(archiveId).get();
        } catch (InterruptedException | ExecutionException e) {
            throw new OpenTokException(e.getMessage());
        }
    ...
    public void testListArchives() throws OpenTokException {
        ...
        ArchiveList archives = null;
        try {
            archives = sdk.listArchives().get();
        } catch (InterruptedException | ExecutionException e) {
            throw new OpenTokException(e.getMessage());
        }
    ...
    public void testStartArchive() throws OpenTokException {
        ...
        Archive archive = null;
        try {
            archive = sdk.startArchive(sessionId, properties).get();
        } catch (InterruptedException | ExecutionException e) {
            throw new OpenTokException(e.getMessage());
        }
        assertNotNull(archive);
    ...
    public void testStartArchiveWithName() throws OpenTokException {
        ...
        Archive archive = null;
        try {
            archive = sdk.startArchive(sessionId, name).get();
        } catch (InterruptedException | ExecutionException e) {
            throw new OpenTokException(e.getMessage());
        }
        assertNotNull(archive);
    ...
    public void testStopArchive() throws OpenTokException {
        ...
        Archive archive = null;
        try {
            archive = sdk.stopArchive(archiveId).get();
        } catch (InterruptedException | ExecutionException e) {
            throw new OpenTokException(e.getMessage());
        }
        assertNotNull(archive);
    ...
    public void testDeleteArchive() throws OpenTokException {
        ...
        try {
            sdk.deleteArchive(archiveId).get();
        } catch (InterruptedException | ExecutionException e) {
            throw new OpenTokException(e.getMessage());
        }
    ...
    public void testCreateSessionWithProxy() throws OpenTokException, UnknownHostException {
        ...
        sdk = new OpenTokAsync.Builder(apiKey, apiSecret).apiUrl(targetServiceBaseUrl).proxy(proxy).build();
